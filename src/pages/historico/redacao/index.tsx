    ...
    useEffect(() => {
        async function loadRedacao() {
            ...
            onSnapshot(q, (snapshot) => {
                ...
                setRedacao(lista[0].total);
                setCompNota([lista[0].c1, lista[0].c2, lista[0].c3, lista[0].c4, lista[0].c5]);
                setTema(lista[0].tema);
                setData(lista[0].created?.toLocaleDateString());
                })
        };
    console.log(redacao);
    console.log(tema);
